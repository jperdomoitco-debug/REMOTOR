...
| **Funcionalidad "Quiero"** |  | Cambiar la sucursal de una OT interna (OTi) cuando el vehículo se traslada entre sedes, conservando el historial de traslados con fecha, sede de origen, sede de destino y motivo |  |  |  |  |  |  |  |  |  |
| **Prioridad** |  | Alta |  | Media | x |  | Baja |  |  | **Módulo / Aplicación** | servicio |
|  |  |  |  |  |  |  |  |  |  |  |  |
| **Versión** | **Fecha** | **Autor** |  |  | **Usuario solicitante** |  |  | **Descripción** |  |  |  |
| 2.0 | 20-09-2026 | Julián Perdomo |  |  | Diana Rosero |  |  | Consultar la sucursal o el satélite actual, registrar cada cambio con su historial de traslados y notificar a la sede de destino. |  |  |  |
| 3.0 | 24-09-2026 | Julián Perdomo |  |  | Diana Rosero |  |  | Nomenclatura OTi, notificación a la sede de destino mediante el módulo transversal y criterios de aceptación consolidados. |  |  |  |

## Situación Actual

Actualmente la Orden de Trabajo (OT) carece de un registro que identifique la sucursal de atención específica en la que se encuentra el vehículo. De igual manera, el sistema no permite gestionar ni documentar traslados de vehículos entre las diferentes sedes de la serviteca. Esta restricción genera puntos ciegos en la operación multi-sede, dificultando el control de inventarios, la asignación de recursos y la visualización del estado real del servicio.

## Situación Deseada

Se debe permitir la asignación y actualización de la sucursal de atención en la Orden de Trabajo interna (OTi). Cuando un vehículo requiera ser movilizado entre sedes para continuar con su servicio, la plataforma permitirá registrar este traslado, generando un historial automatizado. Esto garantizará una trazabilidad completa del recorrido del vehículo, mejorando la logística interna, el control de la operación en tiempo real y la precisión en los tiempos de entrega.
...
- Nomenclatura estandarizada OTi.
...
**6.** **Notificación a la sede destino:** Al registrar el traslado, el módulo transversal notifica a la sede destino por correo, WhatsApp y alerta visual en la campanita.
...
**Entonces** el módulo transversal notifica a la sede destino por correo, WhatsApp y campanita.

**Escenario 6: Bloqueo de cambio en OTi finalizada (excepción)**
...
- Notificación a la sede destino mediante el módulo transversal (correo, WhatsApp y campanita).
