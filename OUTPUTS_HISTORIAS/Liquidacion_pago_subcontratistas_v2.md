...
| 2.0 | 20-09-2026 | Julián Perdomo |  |  | Diana Rosero |  |  | Transformación a versión 2.0: porcentaje parametrizable por contrato con vigencia e historial, cálculo automático del neto sobre lo facturado descontando repuestos del almacén interno (OTi obligatoria) y registro del soporte de pago con trazabilidad |  |  |  |
...
4. **Contratos informativos (solo lectura):** El contrato se asocia a la parametrización como dato de solo lectura; la coordinación puede ajustar la entidad de facturación sin alterar la propiedad del vehículo.
...
6. **Validación de rango:** El porcentaje debe ser un número entero entre 0 y 100; no se admiten decimales ni valores negativos.
...
Dado que el Coordinador ingresa un porcentaje menor a 0, mayor a 100 o con decimales
Cuando intenta guardar la configuración
Entonces el sistema bloquea el guardado y muestra "Porcentaje inválido: debe ser un entero entre 0 y 100".
...
- Validación de rango (entero entre 0 y 100).
...
5. **Montos enteros:** Los valores se expresan sin decimales fraccionarios.
6. **Control de neto negativo:** Si el valor de los repuestos supera el porcentaje facturado, el sistema lo advierte antes de continuar.
...
**[MODIFIED]**
- El cálculo deja de ser manual y se automatiza sobre la OTi (antes: 30% de lo cobrado menos repuestos).

**[REMOVED]**
- Cálculo manual de la liquidación (30% − repuestos) sin registro sistematizado.
...
**[MODIFIED]**
- El pago ahora queda registrado y trazable en el sistema (antes sin registro ni histórico de liquidaciones).
